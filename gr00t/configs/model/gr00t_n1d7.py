...
class Gr00tN1d7Config(PretrainedConfig):
    ...
    image_crop_size: Any = (230, 230)
    image_target_size: Any = (256, 256)
    ...
    # Pack current L2/R2 before five-frame arm-joint history and current
    # grippers for the teacher-requested timing ablation. Disabled by default.
    pack_current_pressure_then_joint_history: bool = False
    # Pack current L2/R2 before five-frame 16D proprioception history
    # (both arms and both grippers). Disabled by default.
